...
export default function TerrainMesh({
  ...
  const material = useMemo(() => {
    if (substrate === "sand") {
      ...
      return new THREE.MeshStandardMaterial({ map: sandColor, roughnessMap: sandRough, color: "#e8dbb8", roughness: 0.95, metalness: 0, side: THREE.DoubleSide, envMapIntensity: 0 });
    }
